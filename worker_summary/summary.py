...
#     parser.add_argument('--vocab_path', default='./vocab.txt', type=str, required=False, help='选择词库')
...
#     parser.add_argument('--max_len', type=int, default=25, required=False, help='su3,超过指定长度则进行截断')
#     parser.add_argument('--max_history_len', type=int, default=3, required=False, help="dialogue history的最大长度")
#     parser.add_argument('--no_cuda', action='store_true',required=False, help='不使用GPU进行预测')
